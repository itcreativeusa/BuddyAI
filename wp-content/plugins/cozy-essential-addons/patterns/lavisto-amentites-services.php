...
/**
 * Title: PRO: Amentites and Services Grid
 * Slug: cozy-essential-addons/lavisto-amentites-services
 * Categories: lavisto
 */
...
<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--40)"><!-- wp:heading {"textAlign":"center","level":1,"style":{"typography":{"fontSize":"54px","textTransform":"none"},"spacing":{"margin":{"bottom":"80px"}}}} -->
    ...
    <!-- wp:cozy-block/featured-content-box {"blockClientId":"03a3ddc8-abed-401b-bd62-b092e842d850","gridOptions":{"enableMasonry":false,"columnCount":3,"gap":64}} -->
    <div class="cozy-block-featured-content-box display-grid layout-default   hover-show" id="cozyBlock_03a3ddc8_abed_401b_bd62_b092e842d850">
        <div class="cozy-grid-wrapper "><!-- wp:cozy-block/grid -->
            <div class="cozy-block-grid"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"layout":{"type":"constrained"}} -->
