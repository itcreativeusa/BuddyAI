 ...
 */
?>
<!-- wp:group {"metadata":{"categories":["storemate"],"patternName":"cozy-essential-addons/storemate-product-slider","name":"PRO: Product Slider"},"style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained","contentSize":"100%"}} -->
<div class="wp-block-group" style="margin-top:0;margin-bottom:0"><!-- wp:cozy-block/product-slider {"blockClientId":"3eef5ff3-e25e-4685-a8be-fa1fe8ce4c3a","pagination":{"enabled":true,"width":12,"height":12,"borderRadius":20,"activeWidth":12,"activeBorderRadius":20,"activeColor":"#e56404","color":"#FFFFFF","activeColorHover":"#007766","colorHover":"#e56404","verticalPosition":20},"navigation":{"enabled":true,"iconSize":15,"iconBoxWidth":45,"iconBoxHeight":45,"borderRadius":50,"backgroundColor":"#FFFFFF","color":"#007766","backgroundColorHover":"#007766","colorHover":"#fff"}} -->
<div class="cozy-block-product-slider hover-show" id="cozyBlock_3eef5ff3_e25e_4685_a8be_fa1fe8ce4c3a"><!-- wp:query {"queryId":5,"query":{"perPage":10,"postType":"product"},"lock":{"move":"false","remove":"true"},"className":"cozy-product-slider__swiper-container"} -->
...
<!-- wp:cover {"useFeaturedImage":true,"customOverlayColor":"#e1eaed","isUserOverlayColor":true,"minHeight":540,"customGradient":"linear-gradient(90deg,rgb(5,5,5) 0%,rgba(0,0,0,0.18) 100%)","contentPosition":"center center","isDark":false,"style":{"spacing":{"padding":{"left":"var:preset|spacing|50"}},"elements":{"link":{"color":{"text":"#ffffff"}}},"color":{"text":"#ffffff"}},"layout":{"type":"constrained","contentSize":"1340px"}} -->
<div class="wp-block-cover is-light has-text-color has-link-color" style="color:#ffffff;padding-left:var(--wp--preset--spacing--50);min-height:540px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-100 has-background-dim has-background-gradient" style="background-color:#e1eaed;background:linear-gradient(90deg,rgb(5,5,5) 0%,rgba(0,0,0,0.18) 100%)"></span><div class="wp-block-cover__inner-container"><!-- wp:columns -->
...
<!-- wp:woocommerce/product-rating {"isDescendentOfQueryLoop":true,"fontSize":"normal","style":{"spacing":{"margin":{"right":"var:preset|spacing|20","left":"var:preset|spacing|20"}}}} /--></div>
<!-- /wp:group -->
