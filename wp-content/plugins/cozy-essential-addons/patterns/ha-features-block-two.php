...
/**
 * Title: Features Block Style 2
 * Slug: cozy-essential-addons/ha-features-block-two
 * Categories: ha-patterns-pro
 */
$ct_patterns_images = array(
    COZY_ESSENTIAL_ADDONS_ASSETS_URL . 'admin/images/hello-agency-assets/features_icon.png',
);
?>
...
<div class="wp-block-group hello-agency-animate" style="padding-top:120px;padding-right:var(--wp--preset--spacing--50);padding-bottom:120px;padding-left:var(--wp--preset--spacing--50)"><!-- wp:columns {"style":{"spacing":{"margin":{"top":"100px"},"blockGap":{"left":"80px"}}}} -->
    <div class="wp-block-columns" style="margin-top:100px"><!-- wp:column {"verticalAlignment":"top","width":"40%"} -->
        <div class="wp-block-column is-vertically-aligned-top" style="flex-basis:40%"><!-- wp:group {"style":{"spacing":{"padding":{"bottom":"var:preset|spacing|20"},"blockGap":"var:preset|spacing|30"}},"layout":{"type":"flex","orientation":"vertical"}} -->
