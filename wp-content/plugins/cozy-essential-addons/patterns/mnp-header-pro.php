...
/**
 * Title: Header PRO
 * Slug: cozy-essential-addons/mnp-header-pro
...
<div class="wp-block-group magnewspress-header has-light-color-background-color has-background" style="border-bottom-style:none;border-bottom-width:0px;padding-top:0px;padding-right:0;padding-bottom:0px;padding-left:0"><!-- wp:group {"style":{"spacing":{"padding":{"top":"12px","bottom":"12px","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}}},"backgroundColor":"dark-shade","layout":{"type":"constrained","contentSize":"1400px"}} -->
    <div class="wp-block-group has-dark-shade-background-color has-background" style="padding-top:12px;padding-right:var(--wp--preset--spacing--40);padding-bottom:12px;padding-left:var(--wp--preset--spacing--40)"><!-- wp:columns -->
        <div class="wp-block-columns"><!-- wp:column {"width":"27%"} -->
            ...
            <!-- wp:column {"verticalAlignment":"center","width":"80%","style":{"elements":{"link":{"color":{"text":"var:preset|color|light-color"},":hover":{"color":{"text":"var:preset|color|secondary"}}}}},"textColor":"light-color"} -->
            <div class="wp-block-column is-vertically-aligned-center has-light-color-color has-text-color has-link-color" style="flex-basis:80%"><!-- wp:group {"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"left"}} -->
                <div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20","padding":{"right":"10px"}},"layout":{"selfStretch":"fixed","flexSize":"160px"},"border":{"right":{"color":"var:preset|color|box-background","width":"1px"}}},"className":"newsticker-heading","layout":{"type":"flex","flexWrap":"nowrap"}} -->
                    <div class="wp-block-group newsticker-heading" style="border-right-color:var(--wp--preset--color--box-background);border-right-width:1px;padding-right:10px"><!-- wp:html -->
                        ...
                        <h5 class="wp-block-heading has-light-color-color has-text-color has-link-color has-normal-font-size" style="font-style:normal;font-weight:600"><?php esc_html_e('Breaking News', 'cozy-essential-addons') ?></h5>
                        <!-- /wp:heading -->
                    </div>
                    <!-- /wp:group -->

                    <!-- wp:cozy-block/news-ticker {"blockClientId":"a21a04e1-0f93-4cb6-804d-3f25dfedea11","hoverShow":true,"height":25,"carouselOptions":{"navigation":{"enabled":false,"verticalGap":0,"horizontalGap":60,"iconSize":15,"iconBoxWidth":35,"iconBoxHeight":35,"borderRadius":50,"backgroundColor":"#fff","color":"#007cba","backgroundColorHover":"#007cba","colorHover":"#fff"},"sliderOptions":{"loop":true,"autoplay":true,"slidesPerView":1,"spaceBetween":30,"speed":700}}} -->
                    <div class="cozy-block-news-ticker-wrapper hover-show" id="cozyBlock_a21a04e1_0f93_4cb6_804d_3f25dfedea11"><!-- wp:query {"queryId":1,"query":{"perPage":"6","postType":"post"},"lock":{"move":false,"remove":true},"className":"swiper-container swiper-vertical"} -->
                        <div class="wp-block-query swiper-container swiper-vertical"><!-- wp:post-template {"lock":{"move":false,"remove":true},"className":"swiper-wrapper"} -->
                            <!-- wp:post-title {"isLink":true,"style":{"elements":{"link":{"color":{"text":"var:preset|color|box-background"},":hover":{"color":{"text":"var:preset|color|primary"}}}},"typography":{"fontStyle":"normal","fontWeight":"400"}},"textColor":"box-background","fontSize":"normal","fontFamily":"public-sans"} /-->
                            <!-- /wp:post-template -->
                        </div>
                        <!-- /wp:query -->
                    </div>
            ...
            <!-- wp:column {"width":"25%"} -->
            <div class="wp-block-column" style="flex-basis:25%"><!-- wp:group {"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"right"}} -->
    ...
    <div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-right:0;padding-left:0"><!-- wp:cover {"url":"<?php echo esc_url($ct_patterns_media[0]) ?>","id":8034,"dimRatio":70,"overlayColor":"dark-shade","isUserOverlayColor":true,"minHeight":160,"layout":{"type":"constrained","contentSize":"1400px"}} -->
        <div class="wp-block-cover" style="min-height:160px"><span aria-hidden="true" class="wp-block-cover__background has-dark-shade-background-color has-background-dim-70 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-8034" alt="" src="<?php echo esc_url($ct_patterns_media[0]) ?>" data-object-fit="cover" />
            <div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->
                <div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|30"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left"}} -->
                    <div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"},"typography":{"fontStyle":"normal","fontWeight":"200"}},"layout":{"type":"flex","orientation":"vertical"}} -->
                        <div class="wp-block-group" style="font-style:normal;font-weight:200"><!-- wp:site-logo {"width":334,"shouldSyncIcon":false} /-->

                            <!-- wp:paragraph {"fontSize":"small"} -->
                            <p class="has-small-font-size"><?php esc_html_e('Globe’s most trusted news site', 'cozy-essential-addons') ?></p>
                            <!-- /wp:paragraph -->
                        </div>
                        <!-- /wp:group -->
                    </div>
                    ...
                    <div class="wp-block-group has-light-color-color has-text-color has-link-color"><!-- wp:image {"id":8018,"sizeSlug":"full","linkDestination":"none"} -->
                        <figure class="wp-block-image size-full"><img src="<?php echo esc_url($ct_patterns_media[1]) ?>" alt="" class="wp-image-8018" /></figure>
                        <!-- /wp:image -->
                    </div>
                    <!-- /wp:group -->
                </div>
